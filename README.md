...
When I started this project, I didn't know much about a stack from a heap, didn't know Big-O anything, anything about trees, or how to
...
`git remote add shubham-singla01 https://github.com/shubham-singla01/All-basic-Computer-Science-knowledge-you-will-need-to-work-in-big-4---amazon-fb-google-microsoft`
...
`git rebase shubham-singla01/master `
...
flashcard site : [Anki](http://ankisrs.net/). It uses a repetition system to help you remember. 
...
- ### Bitwise operations
    - [ ] [Bits cheat sheet](https://github.com/shubham-singla01/All-basic-Computer-Science-knowledge-you-will-need-to-work-in-big-4---amazon-fb-google-microsoft/blob/master/extras/cheat%20sheets/bits-cheat-cheet.pdf) - you should know many of the powers of 2 from (2^1 to 2^16 and 2^32)
...
- [ ] Practicing the system design process: Here are some ideas to try working through on paper, each with some documentation on how it was handled in the real world:
    ...
    - [cheat sheet](https://github.com/shubham-singla01/All-basic-Computer-Science-knowledge-you-will-need-to-work-in-big-4---amazon-fb-google-microsoft/blob/master/extras/cheat%20sheets/system-design.pdf)
    - flow:
